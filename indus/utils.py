...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            link = "[Here](https://t.me/IndusBots)"
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        from pathlib import Path
        path = Path(f"indus/plugins/{shortname}.py")
        name = "indus.plugins.{}".format(shortname)
        ...
        sys.modules["indus.utils"] = indus.utils
        mod.Config = Config
        mod.indus = bot
        mod.borg = bot
        sys.modules["indus.events"] = indus.utils
        spec.loader.exec_module(mod)
        # for imports
        sys.modules["indus.plugins."+shortname] = mod
        print("Successfully (re)imported "+shortname)
...
def remove_plugin(shortname):
    try:
        try:
            ...
            name = f"indus.plugins.{shortname}"
