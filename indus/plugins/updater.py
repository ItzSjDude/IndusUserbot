"""Update UserBot code (for IndusUserbot)
Syntax: .update
...
OFFICIAL_UPSTREAM_REPO = "https://github.com/Team-Indus/IndusUserbot"
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit(f"Restarted! do `{CMD_HNDLR}alive or {CMD_HNDLR}help` to check if I am Working or not?")
