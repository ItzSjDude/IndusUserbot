...
@indus.on(admin_cmd(outgoing=True, pattern="del"))
@indus.on(sudo_cmd(allow_sudo=True, pattern="del"))
@errors_handler
...
@indus.on(admin_cmd(outgoing=True, pattern="edit"))
@indus.on(sudo_cmd(allow_sudo=True, pattern="edit"))
@errors_handler
...
@indus.on(admin_cmd(outgoing=True, pattern="sd"))
@indus.on(sudo_cmd(allow_sudo=True, pattern="sd"))
@errors_handler
