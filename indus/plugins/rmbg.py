...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await ievent.edit("Sending to ReMove.BG")
        ...
        await ievent.edit(HELP_STR)
        return
    contentType = output_file_name.headers.get("content-type")
    if "image" in contentType:
        with io.BytesIO(output_file_name.content) as remove_bg_image:
            remove_bg_image.name = "@indusbots.png"
        ...
        await ievent.edit("Removed Tht Annoying BG in {} seconds, powered by @Indusbots".format(ms))
    else:
        await ievent.edit("ReMove.BG API returned Errors. Please report to @Indusbots\n`{}".format(output_file_name.content.decode("UTF-8")))
