...
async def _(event):
    ...
    try:
        ...
        driver.close()
        await ievent.edit("Stopping Google Chrome BIN")
        message_id = event.message.id
        if event.reply_to_msg_id:
            message_id = event.reply_to_msg_id
        with io.BytesIO(im_png) as out_file:
            out_file.name = "@IndusBot.png"
        ...
        await ievent.edit(f"Completed screencapture Process in {ms} seconds")
    except Exception:
        await ievent.edit(traceback.format_exc())
